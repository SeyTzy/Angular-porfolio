    ...
    <section id="projects" class="projects">
      <div class="container">
        <div class="section-header">
          ...
          <p class="section-subtitle">Some of the things I've built</p>
        </div>
                ...
                <div class="project-overlay">
                  <div class="project-links">
                    @if (project.githubLink) {
                      <a [href]="project.githubLink" target="_blank" rel="noopener" class="project-link" aria-label="GitHub">
                    ...
                    @if (project.demoLink) {
                      <a [href]="project.demoLink" target="_blank" rel="noopener" class="project-link" aria-label="Demo">
